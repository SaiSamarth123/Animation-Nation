    ...
    return Scaffold(
        ...
        body: ListView(
          children: [
                  ...
                  onTap: () {
                    Navigator.of(context).push(PageRouteBuilder(
                        ...
                        transitionsBuilder:
                          ...
                          return /*RotationTransition(turns: animation, child: child,);*/SlideTransition(
                            position:
            ...
            Card(
                child: ListTile(
                  title: Text("Moana controlling water"),
                  onTap: () {
                    Navigator.of(context).push(PageRouteBuilder(
                        pageBuilder: (context, animation, anotherAnimation) {
                          return RouteSeven();
            ...
            Card(
                child: ListTile(
                  title: Text("Elsa freezing the world"),
                  onTap: () {
                    Navigator.of(context).push(PageRouteBuilder(
                        pageBuilder: (context, animation, anotherAnimation) {
...
class RouteFour extends StatelessWidget {
  const RouteFour({Key? key}) : super(key: key);
...
class RouteFive extends StatelessWidget {
  const RouteFive({Key? key}) : super(key: key);
...
class RouteSeven extends StatelessWidget {
  const RouteSeven({Key? key}) : super(key: key);
